import 'package:fitness/Models/CutBulkFolders/BulkBreakfast/meats_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class bulkMeatsPage extends StatefulWidget {
  bulkMeatsPage({super.key});
  
  @override
  State<bulkMeatsPage> createState() => _bulkMeatsPageState();
}

  
  class _bulkMeatsPageState extends State<bulkMeatsPage> {

    List<bulkMeatsModel> meatDishes = [];

      void _getInitialInfo(){
        meatDishes = bulkMeatsModel.getCategories();
      }

import 'package:fitness/Models/CutBulkFolders/BulkBreakfast/eggDishes_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class bulkEggDishesPage extends StatefulWidget {
  bulkEggDishesPage({super.key});
  
  @override
  State<bulkEggDishesPage> createState() => _bulkEggDishesPageState();
}

  
  class _bulkEggDishesPageState extends State<bulkEggDishesPage> {

    List<bulkEggDishesModel> eggDishes = [];

      void _getInitialInfo(){
        eggDishes = bulkEggDishesModel.getCategories();
      }

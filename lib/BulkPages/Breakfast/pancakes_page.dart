import 'package:fitness/Models/CutBulkFolders/BulkBreakfast/pancakewaffleDishes_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class bulkPancakesPage extends StatefulWidget {
  bulkPancakesPage({super.key});
  
  @override
  State<bulkPancakesPage> createState() => _bulkPancakesPageState();
}

  
  class _bulkPancakesPageState extends State<bulkPancakesPage> {

    List<bulkPancakesModel> pancakeDishes = [];

      void _getInitialInfo(){
        pancakeDishes = bulkPancakesModel.getCategories();
      }
                        ...
                        showMaterialModalBottomSheet(
                         ...
                         builder: (context) => SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Text( 
                              'Ingredients: \n'
                              '${pancakeDishes[index].ingredients} \n'
                              '\n'
                              'Directions:\n'
                              '${pancakeDishes[index].directions}',
                              style: const TextStyle(
                                color: Colors.black,
                                fontSize: 17,
                                fontWeight: FontWeight.w400

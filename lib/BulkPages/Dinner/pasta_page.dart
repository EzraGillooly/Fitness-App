import 'package:fitness/Models/CutBulkFolders/BulkDinner/pasta_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class bulkPastaPage extends StatefulWidget {
  bulkPastaPage({super.key});
  
  @override
  State<bulkPastaPage> createState() => _bulkPastaPageState();
}

  
  class _bulkPastaPageState extends State<bulkPastaPage> {

    List<bulkPastaModel> Dishes = [];

      void _getInitialInfo(){
        Dishes = bulkPastaModel.getCategories();
      }

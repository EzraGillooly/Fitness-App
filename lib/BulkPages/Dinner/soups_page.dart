import 'package:fitness/Models/CutBulkFolders/BulkDinner/soups_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class bulkSoupsPage extends StatefulWidget {
  bulkSoupsPage({super.key});
  
  @override
  State<bulkSoupsPage> createState() => _bulkSoupsPageState();
}

  
  class _bulkSoupsPageState extends State<bulkSoupsPage> {

    List<bulkSoupsModel> Dishes = [];

      void _getInitialInfo(){
        Dishes = bulkSoupsModel.getCategories();
      }

import 'package:fitness/Models/CutBulkFolders/BulkDinner/bbq_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class bulkBbqPage extends StatefulWidget {
  bulkBbqPage({super.key});
  
  @override
  State<bulkBbqPage> createState() => _bulkBbqPageState();
}

  
  class _bulkBbqPageState extends State<bulkBbqPage> {

    List<bulkBbqModel> Dishes = [];

      void _getInitialInfo(){
        Dishes = bulkBbqModel.getCategories();
      }

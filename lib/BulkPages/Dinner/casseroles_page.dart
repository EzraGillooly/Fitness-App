import 'package:fitness/Models/CutBulkFolders/BulkDinner/casserole_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class bulkCasserolePage extends StatefulWidget {
  bulkCasserolePage({super.key});
  
  @override
  State<bulkCasserolePage> createState() => _bulkCasserolePageState();
}

  
  class _bulkCasserolePageState extends State<bulkCasserolePage> {

    List<bulkCasseroleModel> Dishes = [];

      void _getInitialInfo(){
        Dishes = bulkCasseroleModel.getCategories();
      }

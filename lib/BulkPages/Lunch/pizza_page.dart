import 'package:fitness/Models/CutBulkFolders/BulkLunch/CutLunch/pizza_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class bulkPizzaPage extends StatefulWidget {
  bulkPizzaPage({super.key});
  
  @override
  State<bulkPizzaPage> createState() => _bulkPizzaPageState();
}

  
  class _bulkPizzaPageState extends State<bulkPizzaPage> {

    List<bulkPizzaModel> pizzaDishes = [];

      void _getInitialInfo(){
        pizzaDishes = bulkPizzaModel.getCategories();
      }

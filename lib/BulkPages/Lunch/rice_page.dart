import 'package:fitness/Models/CutBulkFolders/BulkLunch/CutLunch/rice_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class bulkRicePage extends StatefulWidget {
  bulkRicePage({super.key});
  
  @override
  State<bulkRicePage> createState() => _bulkRicePageState();
}

  
  class _bulkRicePageState extends State<bulkRicePage> {

    List<bulkRiceModel> riceDishes = [];

      void _getInitialInfo(){
        riceDishes = bulkRiceModel.getCategories();
      }
            ...
            return Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: riceDishes[index].boxColor.withOpacity(0.3), //Adjust color opacity

...
import 'package:fitness/Models/CutBulkFolders/CutDinner/cDinner_category_model.dart';
import 'package:fitness/Models/CutBulkFolders/CutDinner/cDinner_diet_model.dart';
import 'package:fitness/Models/CutBulkFolders/CutDinner/cDinner_popular_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class cutDinnerPage extends StatefulWidget {
  cutDinnerPage({super.key});

  @override
  State<cutDinnerPage> createState() => _cutDinnerPageState();
}

class _cutDinnerPageState extends State<cutDinnerPage> {
  List<cDinnerCategoriesModel> categories = [];
  List<cDinnerDietModel> diets = [];
  List<cDinnerPopularModel> popularDiets = [];

  void _getInitialInfo(){
    categories = cDinnerCategoriesModel.getCategories();
    diets = cDinnerDietModel.getDiets();
    popularDiets = cDinnerPopularModel.getPopularDiets();
  }

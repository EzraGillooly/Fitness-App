import 'package:fitness/Models/CutBulkFolders/CutLunch/cLunch_category_model.dart';
import 'package:fitness/Models/CutBulkFolders/CutLunch/cLunch_diet_model.dart';
import 'package:fitness/Models/CutBulkFolders/CutLunch/cLunch_popular_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class cutLunchPage extends StatefulWidget {
  cutLunchPage({super.key});

  @override
  State<cutLunchPage> createState() => _cutLunchPageState();
}

class _cutLunchPageState extends State<cutLunchPage> {
  List<cLunchCategoryModel> categories = [];
  List<ClunchDietModel> diets = [];
  List<ClunchPopularModel> popularDiets = [];

  void _getInitialInfo(){
    categories = cLunchCategoryModel.getCategories();
    diets = ClunchDietModel.getDiets();
    popularDiets = ClunchPopularModel.getPopularDiets();
  }

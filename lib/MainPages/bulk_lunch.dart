import 'package:fitness/Models/CutBulkFolders/BulkLunch/CutLunch/bLunch_category_model.dart';
import 'package:fitness/Models/CutBulkFolders/BulkLunch/CutLunch/bLunch_diet_model.dart';
import 'package:fitness/Models/CutBulkFolders/BulkLunch/CutLunch/bLunch_popular_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class bulkLunchPage extends StatefulWidget {
  bulkLunchPage({super.key});

  @override
  State<bulkLunchPage> createState() => _bulkLunchPageState();
}

class _bulkLunchPageState extends State<bulkLunchPage> {
  List<bulkLunchCategoriesModel> categories = [];
  List<bulkLunchDietModel> diets = [];
  List<bulkLunchPopularModel> popularDiets = [];

  void _getInitialInfo(){
    categories = bulkLunchCategoriesModel.getCategories();
    diets = bulkLunchDietModel.getDiets();
    popularDiets = bulkLunchPopularModel.getPopularDiets();
  }

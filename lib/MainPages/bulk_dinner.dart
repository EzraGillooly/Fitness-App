...
import 'package:fitness/Models/CutBulkFolders/BulkDinner/bDinner_category_model.dart';
import 'package:fitness/Models/CutBulkFolders/BulkDinner/bDinner_diet_model.dart';
import 'package:fitness/Models/CutBulkFolders/BulkDinner/bDinner_popular_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class bulkDinnerPage extends StatefulWidget {
  bulkDinnerPage({super.key});

  @override
  State<bulkDinnerPage> createState() => _bulkDinnerPageState();
}

class _bulkDinnerPageState extends State<bulkDinnerPage> {
  List<bulkDinnerCategoriesModel> categories = [];
  List<bulkDinnerDietModel> diets = [];
  List<bulkDinnerPopularModel> popularDiets = [];

  void _getInitialInfo(){
    categories = bulkDinnerCategoriesModel.getCategories();
    diets = bulkDinnerDietModel.getDiets();
    popularDiets = bulkDinnerPopularModel.getPopularDiets();
  }

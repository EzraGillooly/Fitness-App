import 'package:fitness/Models/CutBulkFolders/BulkBreakfast/bBreakfast_Diet_model.dart';
import 'package:fitness/Models/CutBulkFolders/BulkBreakfast/bBreakfast_category_model.dart';
import 'package:fitness/Models/CutBulkFolders/BulkBreakfast/bBreakfast_popular_model.dart';

import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class bulkBreakfastPage extends StatefulWidget {
  bulkBreakfastPage({super.key});

  @override
  State<bulkBreakfastPage> createState() => _bulkBreakfastPageState();
}

class _bulkBreakfastPageState extends State<bulkBreakfastPage> {
  List<bulkBreakfastCategoryModel> categories = [];
  List<bulkBreakfastDietModel> diets = [];
  List<bulkBreakfastPopularModel> popularDiets = [];

  void _getInitialInfo(){
    categories = bulkBreakfastCategoryModel.getCategories();
    diets = bulkBreakfastDietModel.getDiets();
    popularDiets = bulkBreakfastPopularModel.getPopularDiets();
  }

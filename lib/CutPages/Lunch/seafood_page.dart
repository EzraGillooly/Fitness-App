import 'package:fitness/Models/CutBulkFolders/CutLunch/seafood_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class cutSeafoodPage extends StatefulWidget {
  cutSeafoodPage({super.key});
  
  @override
  State<cutSeafoodPage> createState() => _cutSeafoodPageState();
}

  
  class _cutSeafoodPageState extends State<cutSeafoodPage> {

    List<seafoodModel> seafoodDishes = [];

      void _getInitialInfo(){
        seafoodDishes = seafoodModel.getCategories();
      }
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      // Padding that holds the seafoodDishes title
                        ...
                        showMaterialModalBottomSheet(
                         ...
                         builder: (context) => SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Text( 
                              'Ingredients: \n'
                              '${seafoodDishes[index].ingredients} \n'
                              '\n'
                              'Directions:\n'
                              '${seafoodDishes[index].directions}',
                              style: const TextStyle(
                                color: Colors.black,
                                fontSize: 17,
                                fontWeight: FontWeight.w400

...
class cutPizzaPage extends StatefulWidget {
  ...
  @override
  State<cutPizzaPage> createState() => _cutPizzaPageState();
}

  
  class _cutPizzaPageState extends State<cutPizzaPage> {

    List<pizzaModel> pizzaDishes = [];

      void _getInitialInfo(){
        pizzaDishes = pizzaModel.getCategories();
      }

import 'package:fitness/Models/CutBulkFolders/CutBreakfast/eggDishes_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class cutEggDishesPage extends StatefulWidget {
  cutEggDishesPage({super.key});
  
  @override
  State<cutEggDishesPage> createState() => _cutEggDishesPageState();
}

  
  class _cutEggDishesPageState extends State<cutEggDishesPage> {

    List<eggDishesModel> eggDishes = [];

      void _getInitialInfo(){
        eggDishes = eggDishesModel.getCategories();
      }
    ...
    Column _eggDishesSection() {
    return Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
      SizedBox(
        height: 625,
        child: GridView.builder(
          // Adds vertical grid list
          itemCount: eggDishes.length,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      // Padding that holds the eggdishes title
                      padding: const EdgeInsets.only(left: 2.0, right: 2.0),
                      child: Text(
                        textAlign: TextAlign.center,
                        eggDishes[index].name,
                    ...
                    Padding( // Padding that holds text under title                      
                      ...
                      child: Text( // Text under food title
                        '${eggDishes[index].level} | ${eggDishes[index].duration} | ${eggDishes[index].calorie}',
                        style: const TextStyle(
                        ...
                        showMaterialModalBottomSheet(
                         ...
                         builder: (context) => SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Text( 
                              'Ingredients: \n'
                              '${eggDishes[index].ingredients} \n'
                              '\n'
                              'Directions:\n'
                              '${eggDishes[index].directions}',
                              style: const TextStyle(
                                color: Colors.black,
                                fontSize: 17,
                                fontWeight: FontWeight.w400

import 'package:fitness/Models/CutBulkFolders/CutDinner/pasta_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class cutPastaPage extends StatefulWidget {
  cutPastaPage({super.key});
  
  @override
  State<cutPastaPage> createState() => _cutPastaPageState();
}

  
  class _cutPastaPageState extends State<cutPastaPage> {

    List<pastaModel> Dishes = [];

      void _getInitialInfo(){
        Dishes = pastaModel.getCategories();
      }

import 'package:fitness/Models/CutBulkFolders/CutDinner/soups_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:modal_bottom_sheet/modal_bottom_sheet.dart';

class cutSoupsPage extends StatefulWidget {
  cutSoupsPage({super.key});
  
  @override
  State<cutSoupsPage> createState() => _cutSoupsPageState();
}

  
  class _cutSoupsPageState extends State<cutSoupsPage> {

    List<soupsModel> Dishes = [];

      void _getInitialInfo(){
        Dishes = soupsModel.getCategories();
      }

...
import 'package:fitness/models/CutBulkFolders/CutBreakfast/fruitDishes_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class cutFruitDishesPage extends StatefulWidget {
  cutFruitDishesPage({super.key});
  
  @override
  State<cutFruitDishesPage> createState() => _cutFruitDishesPageState();
}

  
  class _cutFruitDishesPageState extends State<cutFruitDishesPage> {
      List<fruitDishesModel> fruitDishes = [];

      void _getInitialInfo(){
        fruitDishes = fruitDishesModel.getCategories();
      }
            ...
            return Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: fruitDishes[index].boxColor.withOpacity(0.3), //Adjust color opacity
